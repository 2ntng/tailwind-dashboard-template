...
import serreLogoSquare from "../images/serrebeauty-192x192.png";
import serreLogoWide from "../images/serrebeauty-script-below-light.png";
      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          <NavLink end to="/" className="block">
            <img
              src={sidebarExpanded ? serreLogoWide : serreLogoSquare}
              alt="Logo"
              className="block w-auto transition-transform duration-300 ease-in-out"
              style={{ transform: sidebarExpanded ? "scale(1.1)" : "scale(1)" }}
            />
          </NavLink>
        </div>
